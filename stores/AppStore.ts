...
class AppStore extends Component {
  ...
  //       this.name = obj.name;
  //       this.pictureUrl = obj.picture.data.url;
  //       this.userId=obj.id;
